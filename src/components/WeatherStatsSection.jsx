import { Wind, Gauge, Droplet, Cloud } from "lucide-react"
            ...
            <div className="weather-card-row flex flex-center">
                <div className="weather-grid">
                    <div className="weather-card-1">
                        <StatsCard title="Wind" icon={<Wind size={75} color="white" />} value={props.isMetric ? props.windSpeed : (props.windSpeed * 0.621371).toFixed(1)} isMetric={props.isMetric} unit={props.isMetric ? "kmph" : "mph"}></StatsCard>
                    </div>
                    ...
                    <div className="weather-card-4">
                        <StatsCard title="Cloud Cover" icon={<Cloud size={75} color="white" />} value={props.cloudCover} unit="%"></StatsCard>
                    </div>
                </div>
            </div>

            <div className="custom-shape-divider-bottom-1740415370">
